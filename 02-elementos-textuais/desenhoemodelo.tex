...
Através do erro de posicionamento do robô, encontra-se o ângulo de orientação desejado, dado por: %(\emph{$\theta_{d}$}), como mostrado na \autoref{eq:thetad}. 
\begin{equation}
