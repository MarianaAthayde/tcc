...
\begin{itemize}
	\item Varredura de área em paralelo
	\item Localizar e circular um determinado alvo de forma balanceada
	\item Coordenar a frota para se reajustar conforme o tamanho da frota	 
\end{itemize}

\section{Definição do Problema}
\label{sec:defProb}
Visando cumprir esse objetivo, definiram-se dois problemas. O primeiro, consiste na coordenação de uma frota de robôs para que a mesma se alinhe paralelamente e eles sigam em linha reta, como em problemas de varreduras de área em paralelo. O segundo, consiste em um controle de uma frota de \emph{N} robôs, para que a mesma localize um dado alvo no espaço e o circunde a uma distância \emph{R} e em um período \emph{T}, que se reajustará conforme o tamanho da frota.  
