...
Este trabalho tem como objetivo o estudo de estratégias de controle de formação de uma frota de robôs. Tendo como objetivo secundário o comportamento do sistema em relação à sua estrutura e ao problema, ao se deparar com a falha de um ou mais robôs. Assim como, a implementação deste sistema multiagente em uma plataforma experimental.
