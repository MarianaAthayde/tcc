...
Ao utilizar a ferramenta \emph{MATLAB\textregistered} para visualizar o erro de velocidade angular, percebe-se que ela converge para zero como esperado, como mostrado na \autoref{fig:ewdc}.
