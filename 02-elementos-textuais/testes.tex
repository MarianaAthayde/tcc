...
\end{equation} 
 ...
 Como pode ser visto na \autoref{fig:pol}, a função mapeia muito bem as saídas do motor, o sistema converge para um valor de erro nulo com um tempo de aproximadamente 2 segundos, com uma oscilação de $\pm0.6 rad/s$, bem próximo aos resultados obtidos com o controlador PI ajustado na \autoref{m1ContPID}. %manualmente.
