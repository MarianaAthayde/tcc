...
\titulo{Implementação de estratégias de coordenação de múltiplos robôs móveis na plataforma LEGO Mindstorms}
...
\preambulo{Proposta de Trabalho de Conclusão de Curso apresentadoao  Curso  de  Engenharia  de  Computação  do  CentroFederal de Educação Tecnológica de Minas Gerais.}
