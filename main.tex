...
\begin{document}
    ...
    \include{./02-elementos-textuais/desenhoemodelo}		%Desenho e Modelo do Sistema
    \include{./02-elementos-textuais/testes}			%Testando as Malhas de Controle
    \include{./02-elementos-textuais/simulacoes}            % Simulações
